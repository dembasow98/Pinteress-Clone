...
const Login = () => {
    ...
    return (
        <div className='flex h-screen place-content-center dark:text-white dark:bg-gray-600'>
            <div className='LOGIN-CONTAINER mt-14 flex flex-col items-center text-gray-600 bg-slate-100 rounded shadow-lg shadow-slate-500 w-[80%] h-[70%] sm:w-[60%] xs:w-[55%] md:w-[50%] xm:w-[45%] lg:w-[40%] xl:w-[30%] '>
                    <div className='flex w-full  items-center place-content-center'>
                        <img src={pinterestlogo} alt="logo" className="w-20 h-20 mb-5"/> 
                ...
                <div className='REGISTER flex flex-col items-center min-w-[70%] mt-8 mb-3'>
